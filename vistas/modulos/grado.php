          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="idGrado" placeholder="Ingresar ID Grado" required>
              ...
              <input type="text" class="form-control input-lg" name="idGrupo" placeholder="Ingresar ID Grupo" required>
          ...
          <br>
            ...
            <br>
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="Grado" placeholder="Ingresar Grado" required>
